...
public class ShopBookDataBean {
	...
	public String toString() {
		return "ShopBookDataBean [book_id=" + book_id + ", book_kind="
				+ book_kind + ", book_title=" + book_title + ", book_price="
				+ book_price + ", book_count=" + book_count + ", author="
				+ author + ", publishing_com=" + publishing_com
				+ ", publishing_date=" + publishing_date + ", book_image="
				+ book_image + ", book_content=" + book_content
